        ...
        return $this->syncMappedResource(
            ...
            function (array $page, ?Entity $timeline) {
                ...
                return [
                    ...
                    'summary' => $this->richTextFrom($page, ['Summary', 'Description'], $timeline?->summary),
        ...
        return $this->syncMappedResource(
            ...
            function (array $page, ?CharacterStateTracker $state) {
                ...
                return [
                    ...
                    'current_trauma_profile' => $this->richTextFrom($page, ['Current Trauma Profile'], $state?->current_trauma_profile),
                    'active_psychological_patterns' => $this->richTextFrom($page, ['Active Psychological Patterns'], $state?->active_psychological_patterns),
        ...
        return $this->syncMappedResource(
            ...
            function (array $page, ?PipelineItem $item, int $index) {
                ...
                return [
                    ...
                    'content' => $this->richTextFrom($page, ['Content'], $item?->content),
                    ...
                    'narrative_purpose' => $this->richTextFrom($page, ['Narrative Purpose'], $item?->narrative_purpose),
                    ...
                    'arc_notes' => $this->richTextFrom($page, ['Arc Notes'], $item?->arc_notes),
                    ...
                    'notes' => $this->richTextFrom($page, ['Notes'], $item?->notes),
