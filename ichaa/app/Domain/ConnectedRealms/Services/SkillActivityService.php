...
class SkillActivityService
{
    ...
    private const ACTIVITY_FAMILIES = [
        ...
        'engineering' => ['track' => 'Engineering Orders', 'theme' => 'Clockwork Assembly Yard', 'activities' => ['Candlemark Spring Packet', 'Wayside Trap Mechanism', 'Moonwake Gadget Bench', 'Hearthsign Siege Gear', 'Runebound Engine Coupling', 'Stormglass Trigger Tuning', 'Highguild Survey Device', 'Elderwake Oldhall Engine', 'Mythgate Prototype Yard', 'Crownmark Chief Engineer Trial'], 'location' => 'Clockwork Yard', 'rewards' => [['key' => 'gear_shaving', 'name' => 'Brass Gear'], ['key' => 'engineer_mark', 'name' => 'Caliper']]],
        'enchanting' => ['track' => 'Enchanting Orders', 'theme' => 'Moon Ward Infusion', 'activities' => ['Candlemark Charm Wash', 'Wayside Ward Oil Script', 'Moonwake Socket Rune', 'Hearthsign Trait Binding', 'Runebound Relic Wake', 'Stormglass Major Enchantment', 'Highguild Arcane Seal', 'Elderwake Oldhall Binding', 'Mythgate Gate Rune', 'Crownmark Arcane Binder Rite'], 'location' => 'Moon Ward Annex', 'rewards' => [['key' => 'rune_dust', 'name' => 'Sung Rune Dust'], ['key' => 'enchanter_mark', 'name' => 'Ward-Script']]],
        'jewelcrafting' => ['track' => 'Jewelry Orders', 'theme' => 'Gemcutter Setting', 'activities' => ['Candlemark Copper Bezel', 'Wayside Silver Ring', 'Moonwake Trinket Socket', 'Hearthsign Amulet Frame', 'Runebound Focus Lens', 'Stormglass Gem Trial', 'Highguild Vault Lens', 'Elderwake Starfacet Setting', 'Mythgate Crown Beadwork', 'Crownmark Gem Sovereign Work'], 'location' => 'Gemcutter Row', 'rewards' => [['key' => 'setting_wire', 'name' => 'Fine Setting Wire'], ['key' => 'jeweler_mark', 'name' => 'Loupe-Etched']]],
        ...
        'magic' => ['track' => 'Arcane Trials', 'theme' => 'Moon Ward Channel', 'activities' => ['Candlemark Spark Channel', 'Wayside Ward Circle', 'Moonwake Elemental Focus', 'Hearthsign Ritual Night', 'Runebound Storm Report', 'Stormglass Rune Reading', 'Highguild Spellguard Work', 'Elderwake Oldhall Rite', 'Mythgate Archmage Trial', 'Crownmark Starward Channel'], 'location' => 'Moon Ward Circle', 'rewards' => [['key' => 'magic_seal', 'name' => 'Moonlit Casting'], ['key' => 'focus_shard', 'name' => 'Attuned Focus']]],
    ...
    private static function activityRewardName(string $activityLabel, string $baseName): string
    {
        return "{$activityLabel} {$baseName}";
    }
