...
const form = useForm({
    knower_entity_id: props.state.knower_entity_id ?? '',
    subject_entity_id: props.state.subject_entity_id ?? '',
    subject_secret_id: props.state.subject_secret_id ?? '',
    subject_relationship_id: props.state.subject_relationship_id ?? '',
    subject_group_relationship_id: props.state.subject_group_relationship_id ?? '',
    subject_event_id: props.state.subject_event_id ?? '',
    acquired_from_entity_id: props.state.acquired_from_entity_id ?? '',
    knowledge_type: props.state.knowledge_type ?? '',
    ...
    acquired_through: props.state.acquired_through ?? '',
    acquired_at_era: props.state.acquired_at_era ?? '',
})
...
const sections = computed(() => [
    ...
    },
    {
        ...
        fields: [
            { key: 'knowledge_type', label: 'Knowledge Type', type: 'select', options: props.knowledgeTypes },
            ...
            { key: 'acquired_through', label: 'Acquired Through', type: 'select', options: props.acquisitionMethods },
