<template>
    <ScaffoldFormPage
        ...
        :back-href="route('concurrency-groups.show', props.group.id)"
        back-label="Concurrency Group"
        :cancel-href="route('concurrency-groups.show', props.group.id)"
        submit-label="Save Group"
        processing-label="Saving..."
        :destroy-href="route('concurrency-groups.destroy', props.group.id)"
        :form="form"
        :sections="sections"
        :on-submit="submit"
    />
