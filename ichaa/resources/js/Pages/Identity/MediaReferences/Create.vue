<template>
    <ScaffoldFormPage
        ...
        :cancel-href="route('media-references.index')"
        submit-label="Create Media"
        ...
        ? [
            {
                ...
                help: 'The file is stored in the app media library and its path, MIME type, size, and dimensions are filled automatically.',
            },
        ]
...
const submit = () => form.post(route('media-references.store'), {
