...
<template>
    ...
    <div class="bg-canvas text-muted">
        ...
        />
        <div
            class="relative flex min-h-screen flex-col items-center justify-center selection:bg-danger selection:text-primary"
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    <div class="flex lg:col-start-2 lg:justify-center">
                        <svg
                            class="h-12 w-auto text-primary lg:h-16 lg:text-danger"
                            viewBox="0 0 62 65"
                            fill="none"
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <div
                                    class="absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-surface to-surface"
                                ></div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <svg
                                            class="size-5 text-danger sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                        >
                                ...
                                <svg
                                    class="size-6 shrink-0 stroke-danger"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke-width="1.5"
                        ...
                        >
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                >
                                    <g class="text-danger" fill="currentColor">
                                        <path
                            ...
                            <svg
                                class="size-6 shrink-0 self-center stroke-danger"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                        ...
                        >
                                ...
                                <p class="mt-4 text-base/relaxed">
                                    ...
                                    <a
                                        ...
                                        class="rounded-sm underline hover:text-primary focus:outline-none focus-visible:ring-1 focus-visible:ring-danger"
                                        >Forge</a
                                    >,
                                    <a
